...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="modal" id="create-position">
            <div class="modal-body">
                <h3>Input Position</h3>
                <div class="form-group">
                    <label for=""><b>Masukkan Posisi</b></label>
                    <input type="text" placeholder="Posisi" id="posisi" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for=""><b>Masukkan Tanggal Awal Voting</b></label>
                    <input type="date" placeholder="Start Date" id="start_date" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for=""><b>Masukkan Tanggal Akhir Voting</b></label>
                    <input type="date" placeholder="End Date" id="end_date" class="form-control" required>
                </div>
        ...
        <div class="modal" id="update-position">
            <div class="modal-body">
                <h3>Update Position</h3>
                <input type="hidden" placeholder="Id" id="id" class="form-control">
                <div class="form-group">
                    <label for=""><b>Masukkan Posisi</b></label>
                    <input type="text" placeholder="Posisi" id="edit_posisi" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for=""><b>Masukkan Tanggal Awal Voting</b></label>
                    <input type="date" placeholder="Start Date" id="edit_start_date" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for=""><b>Masukkan Tanggal Akhir Voting</b></label>
                    <input type="date" placeholder="End Date" id="edit_end_date" class="form-control" required>
                </div>
                <div class="form-group buttons">
        ...
        <script src="../assets/js/fetch_api_admin/posisi.js"></script>
    </body>
</html>
